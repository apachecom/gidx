...
compressed_grammar::g_long compressed_grammar::size_in_bytes() const{
    return static_cast<g_long>(sdsl::size_in_bytes(X_p) +
                               sdsl::size_in_bytes(Z) +
                               sdsl::size_in_bytes(select0_Z) +
                               sdsl::size_in_bytes(select1_Z) +
                               sdsl::size_in_bytes(rank1_Z) +
                               sdsl::size_in_bytes(rank0_Z) +
...
void compressed_grammar::left_most_path(const plain_grammar& grammar)
{
    ...
    std::vector<_trie::node::ulong> _stack(m_tree.subtree(m_tree.root()),0);
    g_long top = 0;
