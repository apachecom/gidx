...
void SelfGrammarIndexPTS::locate2( std::string & pattern, sdsl::bit_vector & occ)
{
...
unsigned long SelfGrammarIndexPTS::size_in_bytes() const
{
...
SelfGrammarIndexPTS::SelfGrammarIndexPTS(const uint8_t & s):SelfGrammarIndexPT()
{
    sampling = s;
}
