...
bool dfuds_tree::isleaf(const dfuds_tree::dfuds_long & v) const{
    return !bit_vector[v];
}

dfuds_tree::dfuds_long dfuds_tree::pre_order(const dfuds_tree::dfuds_long & v)const {
    ////assert(v > 2);
    return  v-bps.rank(v)+bit_vector[v] ;
}

dfuds_tree::dfuds_long dfuds_tree::operator[](const dfuds_tree::dfuds_long & i) const{
    return select_0(i)+1;
}
...
dfuds_tree::dfuds_long dfuds_tree::leafselect(const dfuds_tree::dfuds_long & i) const{
    return select_00(i);
}

dfuds_tree::dfuds_long dfuds_tree::child(const dfuds_tree::dfuds_long & v, const dfuds_tree::dfuds_long & t)const {
...
dfuds_tree::dfuds_long dfuds_tree::succ0(const dfuds_tree::dfuds_long &i)const {
    size_t zeros = i - bps.rank(i)+1;
    return select_0(zeros+bit_vector[i]);
}

dfuds_tree::dfuds_long dfuds_tree::size_in_bytes() const{
...
dfuds_tree::dfuds_long dfuds_tree::rank_1(const dfuds_tree::dfuds_long & i) const{
    return bps.rank(i);
}
